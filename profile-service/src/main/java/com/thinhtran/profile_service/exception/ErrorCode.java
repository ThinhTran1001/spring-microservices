...
public enum ErrorCode {
    ...
    USERNAME_INVALID("error", "Username must be at least {min} characters!", HttpStatus.BAD_REQUEST),
    PASSWORD_INVALID("error", "Password must be in range {min} to {max} characters!", HttpStatus.BAD_REQUEST),
    ...
    INVALID_DOB("error", "Your age must be at least {min}!", HttpStatus.BAD_REQUEST);
